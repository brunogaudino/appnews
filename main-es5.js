...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(getRequestNews, formBuilder) {
    ...
    HomeComponent.prototype.submitSearchForm = function () {
        var _this = this;
        var countryName = this.searchForm.get('countryParam').value;
        var categoryName = this.searchForm.get('categoryParam').value;
        this.getRequestNews.getNews('top-headlines', countryName, categoryName).subscribe(function (data) {
            console.log('return news ', data);
            _this.setSearchPage(false);
            return _this.news = data;
        }, function (error) { _this.infoError(error); });
    };
    HomeComponent.prototype.setSearchPage = function (isSearchPage) {
        if (isSearchPage === void 0) { isSearchPage = true; }
...
var RequestNewsService = /** @class */ (function () {
    ...
    RequestNewsService.prototype.getNews = function (typeOfNews, country, category, pageSize) {
        if (typeOfNews === void 0) { typeOfNews = 'top-headlines'; }
